...
export  function Achievement_List() {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100] px-4 sm:px-0 overflow-auto">
            <motion.button
            ...
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-[500px] bg-white dark:bg-neutral-900 rounded-3xl overflow-hidden"
            >
