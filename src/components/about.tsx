  ...
  return (
    <main className="flex h-[70vh] md:min-h-screen w-full flex-col items-center justify-start p-5">
      ...
      <div className="flex flex-col gap-y-5 w-full max-w-xl">
        ...
        <div className="text-center my-4 text-md md:text-lg">
          <p className="mb-5">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit.
            Praesentium et provident accusamus voluptas ipsa libero ea. Sapiente
            quae, excepturi optio, eos modi voluptas ullam porro quod commodi
            aut repellendus dolorem.
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit.
            Praesentium et provident accusamus voluptas ipsa libero ea. Sapiente
