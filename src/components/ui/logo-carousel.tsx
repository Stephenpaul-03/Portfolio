...
// Utility: evenly distribute logos across columns
...
// Single animated column of logos
...
export default function LogoCarousel({ logos, columnCount = 2 }: LogoCarouselProps) {
  ...
  // Distribute logos when input logos or column count changes
  useEffect(() => {
    if (logos.length > 0) {
